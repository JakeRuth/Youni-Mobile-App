...
var CustomSwiper = React.createClass({
   ...
   */
  updateIndex: function(offset, dir) {
  ...
  youniCustomScrollBy: function(index) {
  ...
  scrollViewPropOverrides: function() {
  ...
  renderScrollView: function(pages) {
    if (Platform.OS === 'ios')
      return (
  ...
  _performHackyAutoScroll: function() {
    ...
    if (mainAppSwipePageStore.shouldTriggerAutoScroll()) {
      ...
      mainAppSwipePageStore.setShouldTriggerAutoScroll(false);
    }
  }
